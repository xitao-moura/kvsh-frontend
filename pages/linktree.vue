<template>
    <div>
        ...
        <a id="profilePicture" href="javascript:void(0);">
            <img src="kvsh.jpeg" alt="Profile Picture">
        </a>
        ...
        <div id="links"  v-for="social in socials" :key="social.id">
            <a class="link" :href="social.link" target="_blank">
                <span v-if="social.social" v-html="social.social.icon"></span>  {{ social.titulo }}
            </a>
        </div>
